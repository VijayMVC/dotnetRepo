...
namespace DateTimeLab
{
    public class DateTimeLabCode
    {
        ...
        {
            return (month.ToString() + "/" + day.ToString() + "/" + year.ToString().Substring(2,2));
        }
        ...
        public DateTime GetDateTimeObjectFromString(string date)
        {
            ...
            DateTime.TryParse(date, out ReturnDay);
            return ReturnDay;
        }
        ...
        public string GetDateInSixMonths(string date)
        {
            ...
            return Date.AddMonths(6).ToString("MMMM d, yyyy");            
        }
        ...
        {
            DateTime Date =  DateTime.Parse(date);
            return Date.AddDays(-30).ToString("MMMM d, yyyy");
        }
